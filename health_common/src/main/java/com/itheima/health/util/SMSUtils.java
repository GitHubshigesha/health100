...
public class SMSUtils {
    public static final String VALIDATE_CODE = "SMS_203675711";//发送短信验证码 模板的英文名
    public static final String ORDER_NOTICE = "SMS_159771588";//体检预约成功通知
    private static final String SIGN_NAEM = "黑马程序员";// 短信的签名
    private static final String PARAMETER_NAME="code";
    private static final String ACCESS_KEY="LTAI4Fyc9wrHbEmt8dKzY7pG"; //你的AccessKey ID
    private static final String SECRET_KEY="RRS9XdEgDa1b35rZ6uRF7UqnImS4uk"; //你的AccessKey Secret
