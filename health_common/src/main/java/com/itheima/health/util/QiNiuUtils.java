...
private static final String ACCESSKEY = "o5Ay8P2TyfgBGuTRF3pEVy8K_eBhyLEKfstLcYjy";
    private static final String SECRETKEY = "-XrxCTqOvhOOR9DAycBJB-2T8wGaLG8sQlGdF7BO";
    private static final String BUCKET = "czhm100";
    public static final String DOMAIN= "http://qh0hwklwr.hn-bkt.clouddn.com/";
    public static void main(String[] args) {
        //上传文件
        uploadFile("C:\\Users\\new\\Desktop\test1.jpg","test1.jpg");
